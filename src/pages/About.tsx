        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              نحن فريق متخصص في تنظيم الفعاليات بخبرة تزيد عن 10 سنوات في المملكة العربية السعودية
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  بدأت رحلتنا من الحلم بتقديم خدمات تنظيم فعاليات استثنائية تجمع بين الأصالة والحداثة. 
                  منذ أكثر من عقد من الزمان، نقوم بتنظيم الأفراح والعزاء بأعلى معايير المهنية والاحتراف.
                </p>
                <p>
                  نؤمن بأن كل فعالية لها طابعها الخاص، ولذلك نعمل مع عملائنا لفهم رؤيتهم وتحقيق تطلعاتهم. 
                  فريقنا المتخصص يضمن تنفيذ كل التفاصيل بدقة واهتمام.
                </p>
                <p>
                  نحن نفخر بكوننا الخيار المفضل للعائلات في المملكة العربية السعودية لتنظيم أهم اللحظات في حياتهم.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed">
              نسعى لتقديم خدمات تنظيم فعاليات متميزة تجمع بين الأصالة والعراقة السعودية 
              مع لمسة عصرية من الأناقة والرقي، لنساعد عملاءنا في إنشاء ذكريات جميلة تدوم مدى الحياة
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                يتكون فريقنا من مجموعة من المتخصصين ذوي الخبرة الواسعة في مجال تنظيم الفعاليات. 
                نحن نعمل كفريق واحد لضمان تقديم أفضل الخدمات لعملائنا الكرام.
              </p>
